<template>
  ...
  <InstituteInfoForm
    ...
    :institute-tree-data="props.instituteTreeData"
...
import InstituteInfoForm from "./InstituteInfoForm.vue";
...
function handleQuery() {
  ...
  InstituteAPI.listInstituteByPage(queryParams)
    .then((data) => {
...
function handleChangeState(index: number, row: InstituteInfoDto) {
  ...
  InstituteAPI.updateInstituteState(param)
    .then((_data) => {
...
function handleDelete(row: InstituteInfoDto) {
  ...
  InstituteAPI.deleteInstituteInfo({ id: row.id }).then((_data) => {
