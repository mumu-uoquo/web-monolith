...
import InstituteInfoForm from "./components/InstituteInfoForm.vue";
...
import InstituteAPI, { InstituteInfoDto, InstituteTreeDto } from "@/api/institute";
...
function loadInsituteTree() {
  InstituteAPI.listInstituteByTree().then((data) => {
...
function handleInstituteClick(param: InstituteTreeDto) {
  ...
  InstituteAPI.getInstituteInfo(params).then((data) => {
 ...
 * 刷新子机构数据
 */
const subInstituteListRef = ref(InstituteList);
...
function handleDeleteInstitute() {
  ...
  InstituteAPI.deleteInstituteInfo(params).then((_data) => {
 ...
 * 打开机构表单
 */
const instituteFormRef = ref(InstituteInfoForm);
