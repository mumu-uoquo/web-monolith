...
import MessageAPI, { MsgInfoListParam, MsgInfoDto } from "@/api/message";
import { InstituteInfoDto } from "@/api/institute";
import DatePicker from "@/components/DatePicker/index.vue";
import DictTag from "@/components/DictTag/index.vue";
import SendMsgInfoView from "./components/SendMsgInfoView.vue";
import SendMsgInfoForm from "./components/SendMsgInfoForm.vue";
import SendMsgInfoPublishForm from "./components/SendMsgInfoPublishForm.vue";
...
function handleQuery() {
  ...
  MessageAPI.listMySendMessageByPage(queryParams)
    .then((data) => {
 ...
 * 展示：新增弹窗
 */
const infoFormRef = ref(SendMsgInfoForm);
 ...
 * 展示：发布弹窗（未发布的）
 */
const publishFormRef = ref(SendMsgInfoPublishForm);
...
function handleWithdraw(row: MsgInfoDto) {
  ...
  MessageAPI.withdrawMessage({ id: row.id }).then((_data) => {
...
function handleDelete(row: MsgInfoDto) {
  // console.log("handleDelete", row);
  MessageAPI.deleteMessage({ id: row.id }).then((_data) => {
