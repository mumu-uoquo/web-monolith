...
import LogsAPI, { type LogsAuthSearchParam, type LogUserLoginDto } from "@/api/logs";
...
async function handleQuery() {
  ...
  LogsAPI.logsByAuthList(queryParams)
    .then((data) => {
...
defineOptions({ name: "logs-auth", inheritAttrs: false });
